...
docker pull 565393027942.dkr.ecr.ap-southeast-2.amazonaws.com/spotify-hybrid-recommender-system:latest

echo "Checking for existing container..."
if [ "$(docker ps -q -f name=spotify-hybrid-recommender-system)" ]; then
    echo "Stopping existing container..."
    docker stop spotify-hybrid-recommender-system
fi
...
565393027942.dkr.ecr.ap-southeast-2.amazonaws.com/spotify-hybrid-recommender-system:latest
